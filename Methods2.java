...
//		String[] array containing the string form of these numbers, except for multiples of 3, use "Fizz" instead of
//		the number, for multiples of 5 use "Buzz", and for multiples of both 3 and 5 use "FizzBuzz". In Java,
//		String.valueOf(xxx) will make the String form of an int or other type. This version is a little more
...
//		fizzBuzz(1, 11) → ["1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz"]
		...
		for ( int i = start; i < end; i++ ){
			if ( i % 3 == 0 && i % 5 == 0 ){
				...
				fizzbuzz[count] = Integer.toString(i);
			}
			count++;
		}
